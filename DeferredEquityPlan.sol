...
contract DeferredEquityPlan {
    ...
    uint unlock_time = 365 + start_time ;
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, 'You have to wait for 365 days for the vested shares');
        
        // 2: `distributed_shares` is less than the `total_shares`
        require(distributed_shares < total_shares, 'You have no more shares left to be distributed');
